    ...
    return (
        <Wrapper in>
            <Box display="flex" flexDir={isMobile ? "column" : "row"}>
                <Card boxSize='300px' title="THE KENDALL HOTEL" description={
                    <Description address="350 Main St, Cambridge, MA 02142">
                        <Box paddingBottom="3" display="flex" flexDir="column" justifyContent="flex-start">
                            <Box textAlign="left">Use promo code: <Code>BFWG</Code></Box>
                        </Box>
                    </Description>
                } badge="LODGING" imageSrc="https://elizabethandevan.s3.amazonaws.com/kendall.jpeg">
                ...
                <Card boxSize='300px' title="BOSTON MARRIOTT CAMBRIDGE" description={
                    ...
                    badge="LODGING" imageSrc="https://elizabethandevan.s3.amazonaws.com/marriott.jpeg">
